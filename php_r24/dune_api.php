...
define ('GCOMP_GEOM_OPT_NON_NEGATIVE_X', 0x1);
define ('GCOMP_GEOM_OPT_NON_NEGATIVE_Y', 0x2);
define ('GCOMP_OPT_APPEAR_WITH_FADE', 0x100);
define ('GCOMP_OPT_BG_PICTURE', 0x8);
define ('GCOMP_OPT_DEBUG_FRAME', 0x01000000);
...
define ('GCOMP_OPT_TTF_QUALITY_WRAP', 0x4000);
...
define ('GUI_EVENT_TOPMENU_REFRESH',                     'topmenu_refresh');
...
define ('PLUGIN_OP_GET_VOD_STREAM_INFO',                 'get_vod_stream_info');
...
define ('PLUGIN_OUT_DATA_PLUGIN_STREAM_INFO',            'plugin_stream_info');
...
# enum StreamMarkerType
define ('STREAM_MARKER_INTRO',                           'intro');
define ('STREAM_MARKER_RECAP',                           'recap');
define ('STREAM_MARKER_CLOSING_CREDITS',                 'closing_credits');
...
define ('CHANGE_MOVIE_DATA_ACTION_ID',                   'change_movie_data');
...
define ('CHOOSE_FILE_ACTION_ID',                         'choose_file');
...
define ('EDIT_MOVIE_DATA_ACTION_ID',                     'edit_movie_data');
...
define ('PLUGIN_EXIT_FOLDERS_ACTION_ID',                 'plugin_exit_folders');
...
define ('SYNC_MY_COLLECTION_ACTION_ID',                  'sync_my_collection');
...
define ('WAKE_NETWORK_FOLDER_ACTION_ID',                 'wake_network_folder');
...
class ChangeListConfigActionData
{
    ...
    const /* (MY_StringArray *)               */ order                            = 'order';
    const /* (GuiAction *)                    */ post_action                      = 'post_action';
}

class ChangeMovieDataActionData
{
    const /* (MY_StringArray *)               */ movie_ids_to_delete              = 'movie_ids_to_delete';
    const /* (GuiAction *)                    */ post_action                      = 'post_action';
}
...
class ChooseFileActionData
{
    const /* (FileChooserFilter *)            */ filter                           = 'filter';
    const /* (FileChooserUiParams *)          */ ui_params                        = 'ui_params';
    const /* (GuiAction *)                    */ post_action                      = 'post_action';
}
...
class CreateNetworkFolderActionData
{
    const /* (char *)                         */ name                             = 'name';
    const /* (char *)                         */ url                              = 'url';
    const /* (GuiAction *)                    */ post_action                      = 'post_action';
...
class EditListConfigActionData
{
    ...
    const /* (MY_Properties *)                */ close_item_params                = 'close_item_params';
    const /* (MY_Properties *)                */ dialog_params                    = 'dialog_params';
...
{
    const /* bool                             */ file_type_dir                    = 'file_type_dir';
    const /* (MY_StringArray *)               */ file_extensions                  = 'file_extensions';
    const /* bool                             */ check_writable                   = 'check_writable';
}

class FileChooserUiParams
{
...
class FileMovieInfo
{
    ...
    const /* (char *)                         */ rate_content                     = 'rate_content';
    const /* int                              */ series_type                      = 'series_type';
    const /* int                              */ s                                = 's';
    const /* int                              */ e                                = 'e';
}
...
class PluginExitFoldersActionData
{
...
class PluginStreamInfo
{
    const /* (char *)                         */ url                              = 'url';
    const /* (StreamMarkerList *)             */ markers                          = 'markers';
}
...
class PluginUpdateEpgActionData
{
    ...
    const /* MY_Bool                          */ ext_epg_enabled                  = 'ext_epg_enabled';
    const /* (GuiAction *)                    */ post_action                      = 'post_action';
}
...
class PluginVodGetStreamInfoInputData
{
...
class StreamMarker
{
    const /* StreamMarkerType                 */ type                             = 'type';
    const /* int                              */ from                             = 'from';
    const /* int                              */ to                               = 'to';
...
class SyncMyCollectionActionData
{
    const /* long long                        */ mcf_id                           = 'mcf_id';
    const /* (GuiAction *)                    */ post_action                      = 'post_action';
}
...
class ViewItemParams
{
    ...
    const /* (char *)                         */ item_detailed_info_extra         = 'item_detailed_info_extra';
...
class WakeNetworkFolderActionData
{
    const /* (char *)                         */ folder_id                        = 'folder_id';
    const /* (GuiAction *)                    */ post_action                      = 'post_action';
}
