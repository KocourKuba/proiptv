...
- Дополнительные поля в информации о попдписке для TV Team
...
- Токены/идентификаторы сессии теперь не сохраняются в настройках, во избежании проблем с переносом на другую приставку
