### Следующая версия
- Внедрена поддержка нескольких источников XMLTV для одного плейлиста. К сожалению обработка XMLTV по прежнему тяжелая задача для старых приставок и бюджетных моделей, поэтому закидывать все доступные источники не рекомендуется. Очередность поиска EPG определяется порядком источников в списке.
