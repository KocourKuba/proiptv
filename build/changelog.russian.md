### Версия 5.1.1032
- Добавлены в поставку плагина отсутствущие логотипы провайдеров
- Добавлены пресет EPG сервера iptvx.one
- Убран drm-play из источников
- Добавлена поддержка собственного сервера EPG 
- Обновлены конфигурации шаблонов

### Версия 5.1.1028
- Добавлены в поставку плагина отсутствущие логотипы провайдеров

### Версия 5.1.1024
- Добавлены в поставку плагина отсутствущие иконки
- Обновлена конфигурация по умолчанию
- Исправлена работа с интернет источниками EPG если EPG ID содержит кириллицу
