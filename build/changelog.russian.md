### Версия 5.0.836
- Улучшен механизм поиска иконок в xmltv источнике. Желательно польностью очистить вес кэш EPG после первого запуска, потому что произошли изменения в базе данных хранения информации о иконках.
