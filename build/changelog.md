...
- Исправлена ошибка смены иконок для специальных категорий
- Исправлено зацикливание плагина при обновлении данных для NewUI
- В информацию о канале так же пишется и информация о видео/аудиопотоке
- Принудительная запись изменений расположения категорий/каналов и др. по кнопке STOP
- Поддержка показа информации о подписке для Cbilling, TV Team, Sharaclub
- Обновлен перевод
