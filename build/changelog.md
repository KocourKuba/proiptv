...
- Добавлен костыль для провайдеров которые не знают что тэг EXTM3U по стандарту должен быть только один. Читайте доки, они рулез. ДБ!
...
- Мелкие исправления UI для Dune Pro One 8K (показ некоторых пунктов меню, отключенных для Homatics/Boxy) 
