...
- Добавлена настройка преобразования ссылок https -> http. После недавних изменений на Glanz. По умолчанию отключено. Но нужно учитывать что не все провайдеры потоков поддерживают оба протокола. Никаких преобразований плагин не делает, просто заменяет текст.
